...
function Index() {
     ...
     * It is recommended that this is set to false if the application relies
     * on data from the API to be rendered
     * @type {boolean}
     */
                ...
                switch (e.response.status) {
                    case 401:
                        ...
                        if (document.referrer === import.meta.env.VITE_AUTH_SERVER) {
                             ...
                             *
                             * It is also suggested that renderWithoutApiSuccess is set to false
                             * to prevent components from trying to render without data
                             */
